                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <span
                                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${jadwal?.gayaMengajar === "online"
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <span
                                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${transaksi.statusPembayaran === "accepted"
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center space-x-1">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <Star
                                                key={star}
                                                className={`w-5 h-5 ${star <= (testimoni.rating || 0)
