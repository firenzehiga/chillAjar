...
export function TransactionHistoryPage({ userData, onPaymentSubmit }) {
	...
	const [statusFilter, setStatusFilter] = useState(""); // Tambahkan state filter status
	...
	// Filter berdasarkan status pembayaran dari dropdown
	...
	return (
		<div className="py-8">
			...
			{/* Dropdown filter status pembayaran */}
			<div className="mb-4 flex items-center gap-2">
				<label htmlFor="statusFilter" className="text-gray-700 text-sm">
