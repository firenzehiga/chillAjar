...
export function Hero({ onNavigate }) {
	return (
		<section className="relative left-1/2 right-1/2 w-full -translate-x-1/2 bg-gradient-to-b from-chill-blue to-gray-50 py-12 overflow-hidden">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center relative">
					{/* Badge */}
					<div className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium mb-8 animate-fadeInUp">
					...
					{/* H1 */}
					<h1 className="text-5xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-4">
						<span className="relative inline-block px-2 pb-3">
							<svg
								className="absolute -bottom-3 left-0 w-full text-blue-300"
								viewBox="0 0 410 18"
					...
					{/* Description */}
					<p className="max-w-3xl mx-auto text-lg font-semibold text-gray-600 mt-8">
						ChillAjar menghubungkan mahasiswa dengan mentor sebaya untuk
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 animate-fadeInUp">
						<a
							...
							className="relative group flex items-center justify-center h-14 pl-20 pr-6 rounded-xl text-white font-medium
							bg-gradient-to-r from-blue-500 to-chill-blue-dark shadow-lg
							hover:rotate-[3deg] transition-all duration-300 active:scale-95">
							<div className="absolute left-1 top-1 bottom-1 w-12 rounded-lg bg-white overflow-hidden">
								<img
									src="/hero.png"
									alt="icon"
