        ...
        <div className="p-6 overflow-y-auto flex-1">
          <div className="mb-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="mb-2"><span className="font-medium">Course:</span> {booking.course.title}</p>
              <p className="mb-2"><span className="font-medium">Mentor:</span> {booking.mentor}</p>
              <p className="mb-2"><span className="font-medium">Date:</span> {booking.date}</p>
              <p className="mb-2"><span className="font-medium">Time:</span> {booking.time}</p>
              <p className="mb-2"><span className="font-medium">Mode:</span> {booking.mode}</p>
          ...
          {paymentMethod === 'transfer' && (
            <div className="mb-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg mb-4">
                <p className="mb-2"><span className="font-medium">Bank:</span> BCA</p>
                <p className="mb-2"><span className="font-medium">Account Number:</span> 1234567890</p>
                <p className="mb-2"><span className="font-medium">Account Name:</span> BelajarWoy</p>
              </div>

              <div className="mt-4">
                <label className="block font-medium mb-2">Upload Payment Proof</label>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                  {proofImage ? (
                    <div className="relative">
                      <img src={proofImage} alt="Payment proof" className="max-h-48 mx-auto" />
                      <button
