	...
	return (
		<div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 mb-8 animate-pulse hover:shadow-xl">
			...
			<div className="relative overflow-hidden">
				<div className="w-full h-48 bg-gradient-to-br from-yellow-200 via-yellow-100 to-orange-100 relative">
					{/* Book stack illustration */}
					<div className="absolute top-4 left-4">
						<div className="w-8 h-6 bg-yellow-400 rounded-sm transform -rotate-12 opacity-60" />
						<div className="w-8 h-6 bg-orange-300 rounded-sm transform -rotate-6 -mt-1 opacity-70" />
						<div className="w-8 h-6 bg-yellow-300 rounded-sm -mt-1 opacity-80" />
					</div>

					{/* Pencil illustration */}
					<div className="absolute top-6 right-6">
						<div className="w-1 h-12 bg-yellow-600 rounded-full transform rotate-45" />
				...
				{/* Category tag */}
				<div className="absolute top-3 right-3 bg-gradient-to-r from-yellow-300 to-orange-300 px-4 py-1.5 rounded-full">
			...
			<div className="p-5">
				...
				<div className="flex items-center gap-2 mb-3">
					<div className="w-4 h-4 bg-yellow-400 rounded opacity-60" />
				...
				<div className="mt-4 pt-3 border-t border-gray-100">
					<div className="flex items-center gap-2">
						...
						<div className="flex-1 h-2 bg-gray-200 rounded-full overflow-hidden">
							<div className="h-full bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full animate-pulse w-1/3" />
						</div>
