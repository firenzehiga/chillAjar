...
export function CarouselSkeleton() {
	return (
		<div className="mb-12 w-full flex justify-center px-2">
			<div className="max-w-7xl w-[90vw] h-[400px] bg-gradient-to-br from-yellow-100 via-orange-50 to-yellow-50 rounded-xl animate-pulse relative overflow-hidden shadow-lg">
				{/* Educational background elements */}
				<div className="absolute inset-0 opacity-20">
					{/* Floating books */}
					<div
						className="absolute top-8 left-12 w-8 h-6 bg-yellow-400 rounded transform -rotate-12 animate-bounce"
					...
					<div className="absolute top-20 left-1/3">
						<div className="w-1 h-16 bg-yellow-500 rounded-full transform rotate-45 animate-pulse" />
				...
				<div className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-yellow-300 rounded-full flex items-center justify-center shadow-md">
					<div className="w-6 h-6 bg-white rounded-full animate-pulse" />
				</div>
				<div className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-yellow-300 rounded-full flex items-center justify-center shadow-md">
					<div className="w-6 h-6 bg-white rounded-full animate-pulse" />
				</div>
				...
				<div className="absolute inset-0 flex items-center justify-center">
					<div className="text-center space-y-4">
						<div className="w-32 h-32 bg-white/60 rounded-full mx-auto animate-pulse flex items-center justify-center">
							<div className="w-16 h-16 bg-yellow-400/60 rounded-full animate-spin" />
						</div>
