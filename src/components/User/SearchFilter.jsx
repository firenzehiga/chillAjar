...
export function SearchFilter() {
	...
	const { courseFilters, updateCourseFilter, resetCourseFilters } =
		useAppStore();
	...
	const activeFiltersCount = Object.values(courseFilters).filter((value) => {
						...
						<div className="p-4 space-y-6">
							...
							<div>
								<label className="block text-sm font-medium text-gray-700 mb-2">
									...
									Rentang Harga: Rp{" "}
									{courseFilters.priceRange[0].toLocaleString("id-ID")} - Rp{" "}
									{courseFilters.priceRange[1].toLocaleString("id-ID")}/sesi
								</label>
								<div className="flex items-center space-x-3">
									...
									<input
										...
										max="100000"
										step="25000"
										value={courseFilters.priceRange[1]}
										onChange={(e) =>
