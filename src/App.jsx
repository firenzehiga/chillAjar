                ...
                mentors: [
                    {
                        ...
                        mentorName:
                            course.mentor?.user?.nama || "Unknown Mentor",
                        ...
                        mentorAbout:
                            course.mentor?.deskripsi || "No description",
                        ...
                        mentorPhone:
                            course.mentor?.user?.nomorTelepon || "+1234567890",
            ...
            if (mentorPages.includes(currentPage)) {
                switch (currentPage) {
                    ...
                    case "mentor-manage-courses":
                        return (
                            <MentorCoursesPage onNavigate={handleNavigate} />
                        );
                    ...
                    case "mentor-add-course":
                        return (
                            <MentorFormCoursePage onNavigate={handleNavigate} />
                        );
                    default:
                        break;
                }
                    ...
                    <PaymentModal
                        ...
                        onClose={() => {
                            ...
                            Swal.fire({
                                ...
                                confirmButtonColor: "#3B82F6",
                                footer: "Klik Ikon Profile &gt; Session History &gt; Cek Sesi &gt; Selesaikan Pembayaran.",
                            });
                        }}
