...
const teamsData = [
	{
		...
		image: farrel,
		bio: "Merancang ide bisnis, dan strategi produk untuk memastikan kesuksesan ChillAjar.",
		funFacts: [
			"Team Work Enthusiast 🤝",
			"Penggemar teknologi dan inovasi 🚀",
	...
	// },
	{
		...
		image: higa,
		bio: "Membangun antarmuka pengguna yang responsif dan interaktif, serta mengoptimalkan pengalaman pengguna.",
		funFacts: [
			"Gamer 🎮",
			"Anime and Western movie enthusiast 🎥",
			"Interactive UI lover 💻",
		],
		socials: {
			email: "higa@email.com",
			linkedin: "https://www.linkedin.com/in/firenze-higa-putra-286043290/",
			github: "https://github.com/firenzehiga",
		},
	},
	{
		...
		image: eko,
		bio: "Merancang dan mengelola server, database, dan API untuk mendukung aplikasi web.",
		funFacts: [
			"Ahli dalam database relasional 🗄️",
			"Penggemar teknologi open source 🌐",
		],
		socials: {
			email: "eko@email.com",
